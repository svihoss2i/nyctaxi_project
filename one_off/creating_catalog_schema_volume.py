...
spark.sql("create catalog if not exists nyctaxi managed location 'abfss://unity-catalog-storage@dbstorageyhyxjwgufxlly.dfs.core.windows.net/3541068556709172'")
